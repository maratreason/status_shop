...
<body>
			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="d-none d-sm-block col-4 col-md-6 col-lg-8">
					...
					<nav class="d-none d-lg-block main-menu">
						<ul>
							<li @if(Route::currentRouteNamed('services'))class="active"@endif><a href="{{route('services')}}">Услуги</a></li>
							<li @if(Route::currentRouteNamed('offers'))class="active"@endif><a href="{{route('offers')}}">Акции</a></li>
							<li @if(Route::currentRouteNamed('catalog'))class="active"@endif><a href="{{route('catalog')}}">каталог</a></li>
							<li @if(Route::currentRouteNamed('team'))class="active"@endif><a href="{{route('team')}}">Команда</a></li>
							<li @if(Route::currentRouteNamed('about'))class="active"@endif><a href="{{route('about')}}">О нас</a></li>
							<li @if(Route::currentRouteNamed('contact'))class="active"@endif><a href="{{route('contact')}}">Контакты</a></li>
						</ul>
					</nav>
				</div>
        ...
        <div class="container py-5">
            <div class="row row-cols-3 row-cols-lg-4 justify-content-between">
                ...
                <div class="text-center d-flex flex-column justify-content-between align-items-center">
                    ...
                    <div>
                        <div class="f_08 mb-3">Мы в социальных сетях:</div>
                        <div class="social mb-4">
                            ...
                            <a href="tel:89510668777" title="Позвонить">
                                <svg viewBox="0 0 25 24" xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="d-flex flex-column justify-content-between">
                    <div>
                        <div class="d-flex align-items-start f_08 fw_3 mb-3">
                            <img src="img/icons/map-pin.svg" alt="адрес" class="me-2">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="burger-menu">
        <div class="offcanvas-body">
            ...
            <div class="box">
                <h3 class="white text-center text-sm-start mb-5">Меню</h3>
                <nav class="main-menu">
                    <ul>
                        <li><a href="index.html">Главная</a></li>
                        <li>
                            <a href="" role="button" data-bs-dismiss="offcanvas" data-bs-toggle="modal"
                                data-bs-target="#callback">Запись</a>
                        </li>
                ...
                <form action="" name="bookingForm" id="booking-form">
                    <div id="page-1" class="page active">
                        ...
                        <div class="px-lg-4 f_14">
                            <div class="line">
                                <div class="left">
                                    <img src="img/icons/scissors.svg" alt="Услуга" class="me-2 me-lg-4">
                                    <button type="button" class="white to-page"
                                        data-target="page-2">Услуга</button>
                                </div>
                                <div class="right">
                                    <output id="serviceResult"></output>
                                    <button type="button" class="del ms-2 ms-md-4" data-target="service"
                                        onclick="clear(this)">
                                        <img src="img/icons/edit_off.svg" alt="Удалить">
                                    </button>
                                </div>
                            </div>
                            <div class="line">
                                <div class="left">
                                    <img src="img/icons/people_alt.svg" alt="Мастер" class="me-2 me-lg-4">
                                    <button type="button" class="white to-page"
                                        data-target="page-3">Мастер</button>
                                </div>
                                <div class="right">
                            ...
                            <div class="line">
                                <div class="left">
                                    <img src="img/icons/watch_later.svg" alt="Дата и время"
                                        class="me-2 me-lg-4">
                    ...
                    <div id="page-2" class="page">
                        ...
                        <div class="px-lg-4 f_14">
                            <div class="line justify-content-start">
                                <input type="radio" name="service" id="servID-1" value="Стрижка"
                                    data-out="serviceResult" class="to-page" data-target="page-1">
                                <label for="servID-1" class="ms-2 ms-md-4">Стрижка</label>
                            </div>
                            <div class="line justify-content-start">
                                <input type="radio" name="service" id="servID-2" value="Окрашивание"
                                    data-out="serviceResult" class="to-page" data-target="page-1">
                                <label for="servID-2" class="ms-2 ms-md-4">Окрашивание</label>
                            </div>
                            <div class="line justify-content-start">
                                <input type="radio" name="service" id="servID-3" value="Укладка"
                                    data-out="serviceResult" class="to-page" data-target="page-1">
                                <label for="servID-3" class="ms-2 ms-md-4">Укладка</label>
                            </div>
                        </div>
                    </div>
                    <div id="page-3" class="page">
                        ...
                        <div class="title">Выбор мастера</div>
                        <div class="px-lg-4">
                            <div class="line py-3">
                                <div class="radio-div">
                                    <input type="radio" name="master" data-out="masterResult" value="Максим"
                                        class="to-page" data-target="page-1">
                                    <div class="master-avatar">
                                        <img src="img/team/5.png" alt="">
                                        <div>
                                            <div class="f_12 fw_6 mb-2">Максим</div>
                                            <div class="f_09 mb-2">Парикмахер универсал</div>
                                            <div class="rating">
                            ...
                            <div class="line py-3">
                                <div class="radio-div">
                                    <input type="radio" name="master" data-out="masterResult" value="Елена"
                                        class="to-page" data-target="page-1">
                                    <div class="master-avatar">
                                        <img src="img/team/1.png" alt="">
                                        <div>
                                            <div class="f_12 fw_6 mb-2">Елена</div>
                                            <div class="f_09 mb-2">Парикмахер, коллорист</div>
                                            <div class="rating">
                                                <svg class="grade" viewBox="0 0 24 24"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                            ...
                            <div class="line py-3">
                                <div class="radio-div">
                                    <input type="radio" name="master" data-out="masterResult"
                                        value="Екатерина" class="to-page" data-target="page-1">
                                    <div class="master-avatar">
                                        <img src="img/team/6.png" alt="">
                                        <div>
                                            <div class="f_12 fw_6 mb-2">Екатерина</div>
                                            <div class="f_09 mb-2">Парикмахер, коллорист</div>
                                            <div class="rating">
                                                <svg class="grade" viewBox="0 0 24 24"
                                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="page-4" class="page">
                        ...
                        <div class="px-lg-5 pt-5 f_14">
                            <input type="text" placeholder="Имя" class="w-100 mb-3">
                            <input type="text" placeholder="+7 (___) ___ __ __ " class="w-100 mb-3" required>
                            <input type="text" placeholder="e-mail" class="w-100 mb-3">
                            <input type="text" placeholder="Ваш комментарий" class="w-100 mb-4">
                            <div class="d-flex mb-4">
                                <input type="checkbox" id="consent" class="me-3">
                                <label for="consent" class="f_08">Согласие на обработку персональных
                                    данных</label>
                            </div>
                        </div>
                        ...
                        <div id="quiz-slider" class="carousel slide carousel-fade" data-bs-ride="carousel"
                            ...
                            <div class="carousel-inner">
                                <fieldset class="carousel-item active">
                                    ...
                                    <div class="font-2 text-center f_15 mb-3">Шаг 1</div>
                                    <div class="font-2 f_14 fw_5 text-center mb-4 mb-sm-5">Пришлите один или
                                        несколько фотопортретов в дневном освещении</div>
                                    <div class="row row-cols-sm-2">
                                        ...
                                        <div>
                                            <div class="input-file-hidden mx-auto mx-sm-0">
                                                <button type="button" class="btn_main btn_2">Загрузить
                                                    фото</button>
                                    ...
                                    <button type="button" class="btn_main btn_1 mx-auto mt-3 mt-sm-5"
                                        ...
                                        disabled="disabled"><span class="f_09">следующий
                                            шаг</span></button>
                                    <div class="text-center f_09 light-gray mt-3">*Ваши фото будет удалены
                                        сразу после анализа</div>
                                </fieldset>
                                <fieldset class="carousel-item">
                                    <div class="indicators mb-4"></div>
                                    <div class="font-2 text-center f_15 mb-3">Шаг 2</div>
                                    <div class="font-2 f_14 fw_5 text-center mb-4 mb-sm-5">Фото корней
                                        (дневное освещение)</div>
                                    <div class="row row-cols-sm-2">
                                        <div class="mb-4 mb-sm-0">
                                ...
                                <fieldset class="carousel-item">
                                    <div class="indicators mb-4"></div>
                                    <div class="font-2 text-center f_15 mb-3">Шаг 3</div>
                                    <div class="font-2 f_14 fw_5 text-center mb-4 mb-sm-5">Фото всей длины
                                        (дневное освещение)</div>
                                    <div class="row row-cols-sm-2">
                                        <div class="mb-4 mb-sm-0">
                                ...
                                <fieldset class="carousel-item">
                                    <div class="indicators mb-4"></div>
                                    <div class="font-2 text-center f_15 mb-3">Шаг 4</div>
                                    <div class="font-2 f_14 fw_5 text-center mb-4 mb-sm-5">Ответьте на
                                        несколько вопросов</div>
                                    <div class="row justify-content-center">
                                        <div class="col-lg-7 col-xxl-6">
                                            <div class="font-2 f_12 fw_3 mb-2 mb-sm-3">Хотите цвет
                                                темнее или светлее?</div>
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <input type="radio" class="verify"
                                                        ...
                                                        value="Темнее" oninput="verifyInp(this);"
                                                        required>
                                                    <label for="darker" class="ms-3">Темнее</label>
                                                </div>
                                                <div class="d-flex align-items-center">
                                                    <input type="radio" class="verify"
                                                        name="desired-color" id="lighter"
                                                        value="Светлее" oninput="verifyInp(this);"
                                                        required>
                                                    <label for="lighter"
                                                        class="ms-3">Светлее</label>
                                                </div>
                                            </div>
                                            <div class="font-2 f_12 fw_3 mb-2 mb-sm-3">Ваши волосы
                                                сейчас окрашены?</div>
                                            <div
                                                class="d-flex justify-content-between font-2 f_11 mb-4 mb-sm-5">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <label for="dyed" class="ms-3">Да</label>
                                                </div>
                                                <div class="d-flex align-items-center">
                                                    <input type="radio" class="verify"
                                                        ...
                                                        value="не окрашенные"
                                                        oninput="verifyInp(this);" required>
                                                    <label for="not-dyed" class="ms-3">Нет</label>
                                                </div>
                                            </div>
                                            <div class="font-2 f_12 fw_3 mb-2 mb-sm-3">Чем?</div>
                                            <input type="text" name="text" placeholder="Название краски"
                                            ...
                                            <div class="d-flex justify-content-between mt-4 mt-sm-5">
                                                ...
                                                <button type="button" class="btn_main btn_1"
                                                    ...
                                                    data-bs-slide="next" disabled="disabled"><span
                                                        class="f_09">следующий шаг</span></button>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset class="carousel-item">
                                    <div class="indicators mb-4"></div>
                                    <div class="font-2 text-center f_15 mb-3">Шаг 5</div>
                                    <div class="font-2 f_14 fw_5 text-center mb-1">Оставьте Ваши контактные
                                        данные</div>
                                    <div class="font-2 f_12 fw_3 text-center mb-4 mb-sm-5">Для получения
                                        результатов введите номер телефона</div>
                                    <div class="row justify-content-center">
                                        <div class="col-lg-7 col-xxl-6">
                                            <input id="tel" type="text" name="phone"
                                                placeholder="Номер телефона" class="white w-100"
                                                required>
                                            <div class="d-flex justify-content-between mt-4 mt-sm-5">
                                                <button type="button" class="btn_main btn_2 me-4"
                                                    data-bs-target="#quiz-slider"
                                                ...
                                                <button type="submit" class="btn_main btn_1"><span
                                                        class="f_09">Готово</span></button>
                                            </div>
                                            <div class="text-center f_09 light-gray mt-3">Нажимая
                                                “Готово”, Вы соглашаетесь условиями с обработки
                ...
                <div class="box">
                    <form id="form_recording" action="">
                        ...
                        <input id="tel" name="phone" placeholder="Номер телефона" class="white w-100 mb-3"
                            required>
                        <textarea type="text" name="comment" rows="3" placeholder="Комментарий"
                            class="white w-100 mb-4"></textarea>
                        <div class="d-flex mb-4">
                            <input type="checkbox" name="agree" id="consent" class="me-3" required>
                            <label for="consent" class="f_08">Согласие на обработку персональных данных</label>
                        </div>
    ...
    <div class="modal fade" id="success-message" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="box py-4">
                    <div class="white text-center f_12">Ваша заявка отправлена</div>
                    <button type="button" class="btn_main btn_1 mx-auto mt-4" data-bs-dismiss="modal">
                        <span class="f_09">Закрыть</span>
                    </button>
                </div>
            </div>
        </div>
